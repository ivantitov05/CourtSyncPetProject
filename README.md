...
- **Документирование:** Markdown, PDF (для печати)
- **Диаграммы:** PlantUML / Draw.io (укажите своё)
- **Управление требованиями:** Notion / Excel (укажите своё)
- *(Если есть код на Java Spring по этому проекту — добавьте строчку)*
